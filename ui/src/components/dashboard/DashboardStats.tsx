...
export function DashboardStats({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
      <div className="card card-lime p-3 kinetic-card animate-fade-in-up" style={{ animationDelay: "0.05s", animationFillMode: "forwards", opacity: 0 }}>
        ...
        <div className="mono font-bold animate-pulse-glow" style={{ fontSize: 20, color: 'var(--accent)', marginTop: 3 }}>
      ...
      <div className="card p-3 kinetic-card animate-fade-in-up" style={{ borderLeft: '3px solid #00F0FF', background: 'linear-gradient(135deg, rgba(0,240,255,0.1), rgba(13, 17, 23, 0.5))', animationDelay: "0.15s", animationFillMode: "forwards", opacity: 0 }}>
        ...
        <div className="mono font-bold data-shimmer" style={{ fontSize: 17, marginTop: 3 }}>
